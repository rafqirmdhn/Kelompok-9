                                ...
                                <div class="panel-body">
                                    ...
                                    <div style="margin-top: 50px">
                                        <p style="text-align: center;" style="font-size: 20px">Form Update Tiket</p>
                                            <form method = 'post' action= "tabelUpdate.html">
                                              <table>
                                               <tr>
                                                <td style="padding-right: 200px; width: 100px;">Kode Tiket</td>
                                                <td>:</td>
                                                <td><input type='text' name='KodeTiket'></td>
                                               <tr>
                                                <tr>
                                                <td style="padding-right: 200px; width: 100px; padding-bottom: 20px;">Nomor Penerbangan</td>
                                                <td>:</td>
                                                <td><input type='text' name='NomorPenerbangan'></td>
                                               <tr>
                                                <tr>
                                                <td style="padding-right: 200px; width: 100px; padding-bottom: 20px;">Kelas</td>
                                                <td>:</td>
                                                <td><input type='text' name='Kelas'></td>
                                               <tr>
                                                <tr>
                                                <td style="padding-right: 200px; width: 100px; padding-bottom: 20px;">Asal</td>
                                                <td>:</td>
                                                <td><input type='text' name='Asal'></td>
                                               <tr>
                                                <tr>
                                                <td style="padding-right: 200px; width: 100px; padding-bottom: 20px;">Tujuan</td>
                                                <td>:</td>
                                                <td><input type='text' name='Tujuan'></td>
                                               <tr>
                                                <tr>
                                                <td style="padding-right: 200px; width: 100px; padding-bottom: 20px;">Harga</td>
                                                <td>:</td>
